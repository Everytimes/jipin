...
if ($_REQUEST['act'] == 'insert')
{
    ...
    /* 插入数据库。 */
    $sql = "INSERT INTO ".$hhs->table('bonus_type')." (free_all,suppliers_id,only_first,number,is_share,type_name, type_money,send_start_date,send_end_date,use_start_date,use_end_date,send_type,min_amount,min_goods_amount)
    VALUES ('$_POST[free_all]','$_POST[suppliers_id]','$_POST[only_first]','$_POST[number]','$_POST[is_share]','$type_name',
            '$_POST[type_money]',
            '$send_startdate',
            '$send_enddate',
            '$use_startdate',
