...
function order_list($refund_ex="",$is_page=true,$is_suppliers=false)
{
    ...
    if ($result === false)
    {
       ...
       //and extension_code!='team_goods'
        ...
        /* 查询 */
        if($is_page){
            $sql = "SELECT o.is_luck,o.is_lucker,o.is_miao,o.surplus,o.bonus, o.package_one, o.point_id,o.transaction_id,o.team_status,o.team_sign,o.team_first, o.order_id, o.order_sn, o.add_time,o.pay_time, o.order_status, o.shipping_status, o.order_amount, o.money_paid," .
...
function team_list($refund_ex="",$is_suppliers=true)
{
    ...
    if ($result === false)
    {
        ...
        $sql ="SELECT o.is_luck,o.is_lucker,o.package_one, o.shipping_name,o.package_one,o.discount_type,o.discount_amount,o.team_num,u.uname,o.transaction_id,o.teammen_num,(o.team_num-o.teammen_num) as team_lack_num, o.team_status,o.team_sign,o.team_first,o.extension_code, o.order_id, o.order_sn, o.add_time,o.pay_time, o.order_status, o.shipping_status, o.order_amount, o.money_paid," .
 ...
 */
        ...
        /* 查询 */
        $sql ="SELECT o.is_luck,o.is_lucker, o.discount_type,o.discount_amount,o.team_num,o.transaction_id,u.uname,o.teammen_num,(o.team_num-o.teammen_num) as team_lack_num, o.team_status,o.team_sign,o.team_first,o.extension_code, o.order_id, o.order_sn, o.add_time,o.pay_time, o.order_status, o.shipping_status, o.order_amount, o.money_paid," .
            "o.pay_status, o.consignee, o.address, o.email, o.tel,  o.extension_id, " .
            "(" . order_amount_field('o.') . ") AS total_fee, " .
