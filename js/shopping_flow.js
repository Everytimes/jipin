...
function selectShipping(obj)
{
  ...
  var express_id = obj.getAttribute('id') || 0;

  var now = new Date();
  Ajax.call('flow.php?step=select_shipping', 'shipping=' + obj.value+ '&express_id=' + express_id, orderShippingSelectedResponse, 'GET', 'JSON');
}
