 ...
 * ============================================================================
 * $Author: pangbin $
 * $Id: zhjs_express.php 17217 2014-05-12 06:29:08Z pangbin $
 */
...
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/zhjs_express.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'zhjs_express_desc';
    ...
    /* 打印单背景 */
    $modules[$i]['print_bg'] = '/images/receipt/dly_zhjs_express.jpg';
...
class zhjs_express
{
     ...
     * @return null
     */
    function zhjs_express($cfg=array())
    {
