...
function get_user_orders_ex($user_id, $num = 10, $start = 0,$ext=null)
{
    ...
    $sql = "SELECT is_lucker,is_comm,shipping_fee,order_id,share_pay_type, order_sn, order_status, shipping_status, pay_status,pay_id, add_time,order_amount, shipping_name,shipping_id,invoice_no, " .
...
function get_user_team_orders($user_id, $num = 10, $start = 0,$ext=null)
{
    ...
    /* 取得订单列表 */
    $arr    = array();
    $sql = "SELECT square,extension_id,team_sign,team_first,team_status,order_id, order_sn, order_status, shipping_status, pay_status, add_time, " .
