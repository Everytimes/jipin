...
{
    $sql = "SELECT b.free_all,u.bonus_sn, u.order_id,u.used_time,u.suppliers_id,b.is_share, b.type_name, b.type_money, b.min_goods_amount, b.use_start_date, b.use_end_date ".
        " FROM " .$GLOBALS['hhs']->table('user_bonus'). " AS u ,".
        $GLOBALS['hhs']->table('bonus_type'). " AS b".
        " WHERE u.bonus_type_id = b.type_id AND u.user_id = '" .$user_id. "'";
