...
if (!empty($_REQUEST['cid']))
{
    ...
    {
       // $_SESSION['cid'] = $cid = 311; 
	   // 去除固定西安区域　2016-3-18, WJJ
...
{
    $_SESSION['xaphp_sopenid']='oFC46wEaIka_xVY3Bc3vlF3cpMfo';
}
else if(isset($_REQUEST['ii'])&&$_REQUEST['ii']=='jiankang')
{
    $_SESSION['xaphp_sopenid']='oFC46wJTQGI0a07szXRr-BFVSHK8';  
}
