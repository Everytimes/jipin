...
function get_order_list($is_page=true,$action=null){
	...
	$sql = "SELECT o.point_id,o.team_first,o.order_id,o.user_id, o.order_sn,o.mobile,o.msg_code, o.add_time, o.order_status, o.shipping_status, o.order_amount, o.money_paid," .
	
			"o.pay_status, o.consignee, o.province, o.city, o.address, o.email, o.tel, o.extension_code, o.extension_id, " .
	...
	foreach ($row AS $key => $value)
	{
        ...
        $sql1 = "SELECT concat(IFNULL(p.region_name, ''), " .
        ...
        $row[$key]['region'] = $GLOBALS['db']->getOne($sql1);
...
//	var_dump($_SESSION['suppliers_id']);
//    exit;
	$suppliers_id=$_SESSION['suppliers_id'];
	$page = isset($_REQUEST['page']) ? intval($_REQUEST['page']) : 1;
