...
block_get('37,48,39,40,38,49,41,50,42,51,43,44,45,52,46,53,47,36');?><?php include template('common/header'); ?><div id="pt" class="bm cl">
...
<style id="diy_style" type="text/css">#portal_block_36 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#portal_block_37 {  margin-top:10px !important;margin-right:0px !important;margin-bottom:0px !important;margin-left:0px !important;}#portal_block_38 {  margin-top:8px !important;margin-right:0px !important;margin-bottom:0px !important;margin-left:0px !important;}</style>
<?php if(empty($gid)) { ?>
<div class="wp">
...
<?php } ?>	
<!--[diy=devil_temp01]--><div id="devil_temp01" class="area"><div id="frameA3Fcq5" class="cl_frame_bm frame move-span cl frame-1"><div id="frameA3Fcq5_left" class="column frame-1-c"><div id="frameA3Fcq5_left_temp" class="move-span temp"></div><?php block_display('37');?></div></div></div><!--[/diy]-->
<div class="devil_bbsbox cl">
<div class="devil_y_jiao"><img src="template/devil_csyg/style/devil_y_jiao.gif"></div>
<div class="devil_bbsbox_y"<?php if($_GET['diy'] == 'yes' && check_diy_perm($topic)) { ?> style="height:auto;"<?php } ?>>		
<div class="devil_ytit"><!--[diy=devil_tit01]--><div id="devil_tit01" class="area"><div id="frameUyCiFI" class="cl_frame_bm frame move-span cl frame-1"><div id="frameUyCiFI_left" class="column frame-1-c"><div id="frameUyCiFI_left_temp" class="move-span temp"></div><?php block_display('48');?></div></div></div><!--[/diy]--></div>
<div class="devil_yimg">
<!--[diy=devil_bbs01]--><div id="devil_bbs01" class="area"><div id="framegc40yA" class="cl_frame_bm frame move-span cl frame-1"><div id="framegc40yA_left" class="column frame-1-c"><div id="framegc40yA_left_temp" class="move-span temp"></div><?php block_display('39');?></div></div></div><!--[/diy]-->
</div>
<div class="devil_zlb">
<!--[diy=devil_bbs02]--><div id="devil_bbs02" class="area"><div id="frameU7DGWB" class="cl_frame_bm frame move-span cl frame-1"><div id="frameU7DGWB_left" class="column frame-1-c"><div id="frameU7DGWB_left_temp" class="move-span temp"></div><?php block_display('40');?></div></div></div><!--[/diy]-->
</div>
<!--[diy=devil_temp02]--><div id="devil_temp02" class="area"><div id="framepCsWxf" class="cl_frame_bm frame move-span cl frame-1"><div id="framepCsWxf_left" class="column frame-1-c"><div id="framepCsWxf_left_temp" class="move-span temp"></div><?php block_display('38');?></div></div></div><!--[/diy]-->
<div class="devil_ytit"><!--[diy=devil_tit02]--><div id="devil_tit02" class="area"><div id="frameAIB969" class="cl_frame_bm frame move-span cl frame-1"><div id="frameAIB969_left" class="column frame-1-c"><div id="frameAIB969_left_temp" class="move-span temp"></div><?php block_display('49');?></div></div></div><!--[/diy]--></div>
<div class="devil_zlb">
<!--[diy=devil_bbs03]--><div id="devil_bbs03" class="area"><div id="frameayLzyA" class="cl_frame_bm frame move-span cl frame-1"><div id="frameayLzyA_left" class="column frame-1-c"><div id="frameayLzyA_left_temp" class="move-span temp"></div><?php block_display('41');?></div></div></div><!--[/diy]-->
</div>
</div>
<div class="devil_bbsbox_z"<?php if($_GET['diy'] == 'yes' && check_diy_perm($topic)) { ?> style="height:auto;"<?php } ?>>
<div class="devil_hottit cl">
<!--[diy=devil_tit03]--><div id="devil_tit03" class="area"><div id="frameVuTreZ" class="cl_frame_bm frame move-span cl frame-1"><div id="frameVuTreZ_left" class="column frame-1-c"><div id="frameVuTreZ_left_temp" class="move-span temp"></div><?php block_display('50');?></div></div></div><!--[/diy]-->
</div>
<div class="devil_hot_img">
<div class="devil_swf">
<!--[diy=devil_swf]--><div id="devil_swf" class="area"><div id="framevDcS8c" class="cl_frame_bm frame move-span cl frame-1"><div id="framevDcS8c_left" class="column frame-1-c"><div id="framevDcS8c_left_temp" class="move-span temp"></div><?php block_display('42');?></div></div></div><!--[/diy]-->
</div>  
<div class="devil_title"><!--[diy=devil_tit04]--><div id="devil_tit04" class="area"><div id="frameu0FNDj" class="cl_frame_bm frame move-span cl frame-1"><div id="frameu0FNDj_left" class="column frame-1-c"><div id="frameu0FNDj_left_temp" class="move-span temp"></div><?php block_display('51');?></div></div></div><!--[/diy]--></div>
<div class="devil_zlb devil_csrd">
<!--[diy=devil_bbs04]--><div id="devil_bbs04" class="area"><div id="frameS6gddg" class="cl_frame_bm frame move-span cl frame-1"><div id="frameS6gddg_left" class="column frame-1-c"><div id="frameS6gddg_left_temp" class="move-span temp"></div><?php block_display('43');?></div></div></div><!--[/diy]-->
</div>
</div>        
<div class="devil_hot">
<!--[diy=devil_bbs05]--><div id="devil_bbs05" class="area"><div id="framem2IyDr" class="cl_frame_bm frame move-span cl frame-1"><div id="framem2IyDr_left" class="column frame-1-c"><div id="framem2IyDr_left_temp" class="move-span temp"></div><?php block_display('44');?><?php block_display('45');?></div></div></div><!--[/diy]-->   
<div class="devil_userimg">
<div class="devil_userimg_tit"><!--[diy=devil_tit05]--><div id="devil_tit05" class="area"><div id="framebQs1MK" class="cl_frame_bm frame move-span cl frame-1"><div id="framebQs1MK_left" class="column frame-1-c"><div id="framebQs1MK_left_temp" class="move-span temp"></div><?php block_display('52');?></div></div></div><!--[/diy]--></div>
<div class="devil_user_box">
<!--[diy=devil_bbs06]--><div id="devil_bbs06" class="area"><div id="frameX2zKp2" class="cl_frame_bm frame move-span cl frame-1"><div id="frameX2zKp2_left" class="column frame-1-c"><div id="frameX2zKp2_left_temp" class="move-span temp"></div><?php block_display('46');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
</div>
</div>
<!--[diy=devil_temp03]--><div id="devil_temp03" class="area"></div><!--[/diy]-->
<div class="devil_title cl"><!--[diy=devil_tit06]--><div id="devil_tit06" class="area"><div id="framerL0Ow1" class="cl_frame_bm frame move-span cl frame-1"><div id="framerL0Ow1_left" class="column frame-1-c"><div id="framerL0Ow1_left_temp" class="move-span temp"></div><?php block_display('53');?></div></div></div><!--[/diy]--></div>
<!--[diy=devil_bbs07]--><div id="devil_bbs07" class="area"><div id="frameiMxJA2" class="cl_frame_bm frame move-span cl frame-1"><div id="frameiMxJA2_left" class="column frame-1-c"><div id="frameiMxJA2_left_temp" class="move-span temp"></div><?php block_display('47');?></div></div></div><!--[/diy]-->
<!--[diy=devil_temp04]--><div id="devil_temp04" class="area"><div id="frameKBSusX" class="cl_frame_bm frame move-span cl frame-1"><div id="frameKBSusX_left" class="column frame-1-c"><div id="frameKBSusX_left_temp" class="move-span temp"></div><?php block_display('36');?></div></div></div><!--[/diy]-->
...
<div class="wp">
<!--[diy=devil_diy3]--><div id="devil_diy3" class="area"></div><!--[/diy]-->
</div>
<?php if(!empty($_G['setting']['grid']['showgrid'])) { ?>
<!-- index four grid -->
<div class="fl bm">
<div class="bm bmw cl" style="margin-bottom:0;">
