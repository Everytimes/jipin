...
0
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_common.htm', 1464069251, '4', './data/template/4_4_common_header_misc_faq.tpl.php', './template/devil_csyg', 'common/header_misc_faq')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_qmenu.htm', 1464069251, '4', './data/template/4_4_common_header_misc_faq.tpl.php', './template/devil_csyg', 'common/header_misc_faq')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/pubsearchform.htm', 1464069251, '4', './data/template/4_4_common_header_misc_faq.tpl.php', './template/devil_csyg', 'common/header_misc_faq')
;?>
