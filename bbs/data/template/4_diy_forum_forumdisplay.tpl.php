...
0
|| checktplrefresh('data/diy/./template/devil_csyg//forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1460800622, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/devil_csyg/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/devil_csyg//forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1460800622, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/devil_csyg/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/devil_csyg//forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1460800622, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/devil_csyg/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/devil_csyg//forum/forumdisplay.htm', './template/default/forum/forumdisplay_list.htm', 1460800622, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/devil_csyg/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/devil_csyg//forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1460800622, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/devil_csyg/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/devil_csyg//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1460800622, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/devil_csyg/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/devil_csyg//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1460800622, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/devil_csyg/', 'forum/forumdisplay')
;
block_get('55,56');?><?php include template('common/header'); if($_G['forum']['ismoderator']) { ?>
<script src="<?php echo $_G['setting']['jspath'];?>forum_moderate.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_55 {  border-top:#000000 0px none !important;border-right:#e2e2e2 1px dashed !important;border-bottom:#000000 0px none !important;border-left:#000000 0px none !important;margin-top:15px !important;margin-right:0px !important;margin-bottom:0px !important;margin-left:0px !important;}#portal_block_55 .dxb_bc {  margin-top:0px !important;margin-right:0px !important;margin-bottom:6px !important;margin-left:10px !important;}#frameodoEoO {  border:#dddddd 1px solid !important;margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#portal_block_56 {  border:#000000 0px none !important;margin-top:8px !important;margin-right:0px !important;margin-bottom:0px !important;margin-left:0px !important;}#portal_block_56 .dxb_bc {  margin-top:0px !important;margin-right:8px !important;margin-bottom:0px !important;margin-left:10px !important;}</style>
...
<!--[diy=diy1]--><div id="diy1" class="area"><div id="frameodoEoO" class="devil_bjtj frame move-span cl frame-3-1"><div class="title frame-title" style='background-image:url("template/devil_csyg/style/titlebg.png");background-repeat:repeat-x;'><span class="titletext" style="font-size:14px;color:rgb(255, 102, 0);">编辑推荐</span></div><div id="frameodoEoO_left" class="column frame-3-1-l"><div id="frameodoEoO_left_temp" class="move-span temp"></div><?php block_display('55');?></div><div id="frameodoEoO_center" class="column frame-3-1-r"><div id="frameodoEoO_center_temp" class="move-span temp"></div><?php block_display('56');?></div></div></div><!--[/diy]-->
</div>
<div class="boardnav">
