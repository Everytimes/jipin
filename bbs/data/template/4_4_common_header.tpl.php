...
0
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_common.htm', 1463620569, '4', './data/template/4_4_common_header.tpl.php', './template/devil_csyg', 'common/header')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_qmenu.htm', 1463620569, '4', './data/template/4_4_common_header.tpl.php', './template/devil_csyg', 'common/header')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/pubsearchform.htm', 1463620569, '4', './data/template/4_4_common_header.tpl.php', './template/devil_csyg', 'common/header')
;?>
