...
0
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_common.htm', 1464004773, '4', './data/template/4_4_common_header_group_my.tpl.php', './template/devil_csyg', 'common/header_group_my')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_qmenu.htm', 1464004773, '4', './data/template/4_4_common_header_group_my.tpl.php', './template/devil_csyg', 'common/header_group_my')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/pubsearchform.htm', 1464004773, '4', './data/template/4_4_common_header_group_my.tpl.php', './template/devil_csyg', 'common/header_group_my')
;?>
