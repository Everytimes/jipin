...
0
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_common.htm', 1460801144, '4', './data/template/4_4_common_header_forum_redirect.tpl.php', './template/devil_csyg', 'common/header_forum_redirect')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_qmenu.htm', 1460801144, '4', './data/template/4_4_common_header_forum_redirect.tpl.php', './template/devil_csyg', 'common/header_forum_redirect')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/pubsearchform.htm', 1460801144, '4', './data/template/4_4_common_header_forum_redirect.tpl.php', './template/devil_csyg', 'common/header_forum_redirect')
;?>
