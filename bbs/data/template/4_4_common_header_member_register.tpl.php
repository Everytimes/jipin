...
0
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_common.htm', 1464324422, '4', './data/template/4_4_common_header_member_register.tpl.php', './template/devil_csyg', 'common/header_member_register')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_qmenu.htm', 1464324422, '4', './data/template/4_4_common_header_member_register.tpl.php', './template/devil_csyg', 'common/header_member_register')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/pubsearchform.htm', 1464324422, '4', './data/template/4_4_common_header_member_register.tpl.php', './template/devil_csyg', 'common/header_member_register')
;?>
