...
0
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_common.htm', 1463575645, '4', './data/template/4_4_common_header_connect_login.tpl.php', './template/devil_csyg', 'common/header_connect_login')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_qmenu.htm', 1463575645, '4', './data/template/4_4_common_header_connect_login.tpl.php', './template/devil_csyg', 'common/header_connect_login')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/pubsearchform.htm', 1463575645, '4', './data/template/4_4_common_header_connect_login.tpl.php', './template/devil_csyg', 'common/header_connect_login')
;?>
