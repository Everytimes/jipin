...
0
|| checktplrefresh('data/diy/./template/devil_csyg//forum/viewthread.htm', './template/default/forum/viewthread_node.htm', 1463537906, 'diy', './data/template/4_diy_forum_viewthread.tpl.php', 'data/diy/./template/devil_csyg/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/devil_csyg//forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1463537906, 'diy', './data/template/4_diy_forum_viewthread.tpl.php', 'data/diy/./template/devil_csyg/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/devil_csyg//forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1463537906, 'diy', './data/template/4_diy_forum_viewthread.tpl.php', 'data/diy/./template/devil_csyg/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/devil_csyg//forum/viewthread.htm', './template/default/common/seditor.htm', 1463537906, 'diy', './data/template/4_diy_forum_viewthread.tpl.php', 'data/diy/./template/devil_csyg/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/devil_csyg//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1463537906, 'diy', './data/template/4_diy_forum_viewthread.tpl.php', 'data/diy/./template/devil_csyg/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/devil_csyg//forum/viewthread.htm', './template/default/common/upload.htm', 1463537906, 'diy', './data/template/4_diy_forum_viewthread.tpl.php', 'data/diy/./template/devil_csyg/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/devil_csyg//forum/viewthread.htm', './template/default/common/seccheck.htm', 1463537906, 'diy', './data/template/4_diy_forum_viewthread.tpl.php', 'data/diy/./template/devil_csyg/', 'forum/viewthread')
;
block_get('54');?><?php include template('common/header'); ?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
...
<style id="diy_style" type="text/css">#portal_block_54 {  margin-top:13px !important;margin-right:0px !important;margin-bottom:0px !important;margin-left:0px !important;border:#ffffff 0px none !important;}#portal_block_54 .dxb_bc {  margin-top:0px !important;margin-right:0px !important;margin-bottom:6px !important;margin-left:8px !important;}#framePDN6Xf {  border:#dddddd 1px solid !important;margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}</style>
...
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_top'])) echo $_G['setting']['pluginhooks']['viewthread_top'];?><?php echo adshow("text/wp a_t");?><style id="diy_style" type="text/css">#portal_block_54 {  margin-top:13px !important;margin-right:0px !important;margin-bottom:0px !important;margin-left:0px !important;border:#ffffff 0px none !important;}#portal_block_54 .dxb_bc {  margin-top:0px !important;margin-right:0px !important;margin-bottom:6px !important;margin-left:8px !important;}#framePDN6Xf {  border:#dddddd 1px solid !important;margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}</style>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="framePDN6Xf" class="devil_bjtj frame move-span cl frame-1"><div class="title frame-title" style='background-image:url("template/devil_csyg/style/titlebg.png");background-repeat:repeat;'><span class="titletext" style="font-size:14px;color:rgb(255, 102, 0);">图新鲜</span></div><div id="framePDN6Xf_left" class="column frame-1-c"><div id="framePDN6Xf_left_temp" class="move-span temp"></div><?php block_display('54');?></div></div></div><!--[/diy]-->
</div>
