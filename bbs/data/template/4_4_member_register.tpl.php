...
0
|| checktplrefresh('./template/default/member/register.htm', './template/default/common/seccheck.htm', 1464324422, '4', './data/template/4_4_member_register.tpl.php', './template/devil_csyg', 'member/register')
