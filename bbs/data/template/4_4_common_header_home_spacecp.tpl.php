...
0
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_common.htm', 1460801103, '4', './data/template/4_4_common_header_home_spacecp.tpl.php', './template/devil_csyg', 'common/header_home_spacecp')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_qmenu.htm', 1460801103, '4', './data/template/4_4_common_header_home_spacecp.tpl.php', './template/devil_csyg', 'common/header_home_spacecp')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/pubsearchform.htm', 1460801103, '4', './data/template/4_4_common_header_home_spacecp.tpl.php', './template/devil_csyg', 'common/header_home_spacecp')
;?>
