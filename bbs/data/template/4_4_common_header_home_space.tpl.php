...
0
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_common.htm', 1463537902, '4', './data/template/4_4_common_header_home_space.tpl.php', './template/devil_csyg', 'common/header_home_space')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_qmenu.htm', 1463537902, '4', './data/template/4_4_common_header_home_space.tpl.php', './template/devil_csyg', 'common/header_home_space')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/pubsearchform.htm', 1463537902, '4', './data/template/4_4_common_header_home_space.tpl.php', './template/devil_csyg', 'common/header_home_space')
;?>
