...
0
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_common.htm', 1463539792, '4', './data/template/4_4_common_header_group_index.tpl.php', './template/devil_csyg', 'common/header_group_index')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/header_qmenu.htm', 1463539792, '4', './data/template/4_4_common_header_group_index.tpl.php', './template/devil_csyg', 'common/header_group_index')
|| checktplrefresh('./template/devil_csyg/common/header.htm', './template/default/common/pubsearchform.htm', 1463539792, '4', './data/template/4_4_common_header_group_index.tpl.php', './template/devil_csyg', 'common/header_group_index')
;?>
