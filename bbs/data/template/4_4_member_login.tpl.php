...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1463543233, '4', './data/template/4_4_member_login.tpl.php', './template/devil_csyg', 'member/login')
