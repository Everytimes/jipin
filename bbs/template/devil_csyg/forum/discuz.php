<?PHP exit('Devil Design 版权所有 http://www.cndevil.com');?>
...
<div id="ct" class="wp cl{if $_G['setting']['forumallowside']} ct2{/if}">
	...
	<!--{/if}-->	
	<!--[diy=devil_temp01]--><div id="devil_temp01" class="area"></div><!--[/diy]-->
	<div class="devil_bbsbox cl">
		<div class="devil_y_jiao"><img src="template/devil_csyg/style/devil_y_jiao.gif"></div>
		<div class="devil_bbsbox_y"<!--{if $_GET['diy'] == 'yes' && check_diy_perm($topic)}--> style="height:auto;"<!--{/if}-->>		
			<div class="devil_ytit"><!--[diy=devil_tit01]--><div id="devil_tit01" class="area"></div><!--[/diy]--></div>
			<div class="devil_yimg">
				<!--[diy=devil_bbs01]--><div id="devil_bbs01" class="area"></div><!--[/diy]-->
			</div>
			<div class="devil_zlb">
				<!--[diy=devil_bbs02]--><div id="devil_bbs02" class="area"></div><!--[/diy]-->
			</div>
			<!--[diy=devil_temp02]--><div id="devil_temp02" class="area"></div><!--[/diy]-->
			<div class="devil_ytit"><!--[diy=devil_tit02]--><div id="devil_tit02" class="area"></div><!--[/diy]--></div>
			<div class="devil_zlb">
				<!--[diy=devil_bbs03]--><div id="devil_bbs03" class="area"></div><!--[/diy]-->
			</div>
		</div>
		<div class="devil_bbsbox_z"<!--{if $_GET['diy'] == 'yes' && check_diy_perm($topic)}--> style="height:auto;"<!--{/if}-->>
			<div class="devil_hottit cl">
				<!--[diy=devil_tit03]--><div id="devil_tit03" class="area"></div><!--[/diy]-->
			</div>
			<div class="devil_hot_img">
				<div class="devil_swf">
					<!--[diy=devil_swf]--><div id="devil_swf" class="area"></div><!--[/diy]-->
				</div>  
				<div class="devil_title"><!--[diy=devil_tit04]--><div id="devil_tit04" class="area"></div><!--[/diy]--></div>
				<div class="devil_zlb devil_csrd">
					<!--[diy=devil_bbs04]--><div id="devil_bbs04" class="area"></div><!--[/diy]-->
				</div>
			</div>        
			<div class="devil_hot">
				<!--[diy=devil_bbs05]--><div id="devil_bbs05" class="area"></div><!--[/diy]-->   
				<div class="devil_userimg">
					<div class="devil_userimg_tit"><!--[diy=devil_tit05]--><div id="devil_tit05" class="area"></div><!--[/diy]--></div>
					<div class="devil_user_box">
						<!--[diy=devil_bbs06]--><div id="devil_bbs06" class="area"></div><!--[/diy]-->
					</div>
				</div>
			</div>
		</div>
	...
	<div class="devil_title cl"><!--[diy=devil_tit06]--><div id="devil_tit06" class="area"></div><!--[/diy]--></div>
	<!--[diy=devil_bbs07]--><div id="devil_bbs07" class="area"></div><!--[/diy]-->
	<!--[diy=devil_temp04]--><div id="devil_temp04" class="area"></div><!--[/diy]-->
