...
{/if}
<script type="text/javascript" src="template/mobanbus_wxgz/wxgz_st/js/mobanbusjs.js"></script>
...
<!--{else}-->
   <div class="bus_sd bus_replybd plc cl" id="pid$post[pid]">
       ...
       <div class="message" id="isfirst">
			...
			<div class="bus_sharebox">
				<div class="bus_ft_ico">
			...
			<div id="mcover" onclick="weChat()" style="display:none;"><img src="$_G[siteurl]template/mobanbus_wxgz/wxgz_st/img/wechatbus.png" /></div>
       </div>
  </div>
