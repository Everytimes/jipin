...
<div class="footer">
	<div>
		...
		<!--{else}-->
		<a href="portal.php?mod=index&mobile=2">{lang mobilehome} | <a href="home.php?mod=space&uid={$_G[uid]}&do=profile&mycenter=1">{$_G['member']['username']}</a> | <a href="member.php?mod=logging&action=logout&formhash={FORMHASH}" title="{lang logout}" class="dialog">{lang logout}</a>
		<!--{/if}-->
	</div>
...
<script type="text/javascript" src="$_G[siteurl]template/mobanbus_wxgz/wxgz_st/js/mobanbus.js"></script>
</div>
</html>
<!--{eval updatesession();}-->
