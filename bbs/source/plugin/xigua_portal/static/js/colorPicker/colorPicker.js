;(function ( $, window, document, undefined ) {
    ...
    var defaults = {
        ...
        callback		: $.noop,
        zIndex			: 5,
        default_color   : 'url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAMAAAC67D+PAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAAZQTFRF////zMzMOOqqgwAAABZJREFUeNpiYAQBBjAghUmyBjATIMAACywAMzXQoXEAAAAASUVORK5CYII=)'
    };
    ...
    var htmlGeneralPanel = ['<div class="wind_color_general" style="display:none"><div class="color_general">', htmlGen, '</div><div class="color_list">', htmlList, '</div><div class="color_standard">', htmlStandard, '</div><div class="set_general"><a href="javascript:;" class="J_set_general">'+advance_color+'</a><a class="J_default_color no_color" href="javascript:;">'+default_color+'</a></div></div>'].join('');
