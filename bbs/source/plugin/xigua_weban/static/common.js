...
var img = {
	...
	errorhandle : function(obj, is_err_t) {
		...
		parentnode.append('<div class="loading" style="background:url(source/plugin/xigua_weban/static/icon_loading.gif) no-repeat center center;width:'+parentnode.width()+'px;height:'+parentnode.height()+'px"></div>');
...
var formdialog = {
	init : function() {
		$(document).on('click', '.formdialog', function() {
			popup.open('<img src="source/plugin/xigua_weban/static/icon_loading.gif">');
			var obj = $(this);
