...
$twmenuListUrl = 'action=plugins&operation=config&do='.$pluginid.'&identifier=tom_weixin&pmod=module&act=admin&moduleid=twmenu';
if($_GET['mact'] == 'add'){
    if(submitcheck('submit')){
        ...
        showformheader('plugins&operation=config&do=' . $pluginid . '&identifier=tom_weixin&pmod=module&act=admin&moduleid=twmenu&mact=add');
        showtableheader();
    ...
    if(submitcheck('submit')){
        ...
        showformheader('plugins&operation=config&do=' . $pluginid . '&identifier=tom_weixin&pmod=module&act=admin&moduleid=twmenu&mact=edit&id='.$_GET['id']);
        showtableheader();
        echo '<tr><th colspan="15" class="partition"><a href="'.$twmenuBaseUrl.'"><font color="#F60"><b>' . $moduleLang['twmenu_list_back'] . '</b></font></a></th></tr>';
        echo '<tr class="header"><th>'.$moduleLang['cmd'].'</th><th></th></tr>';
    ...
    echo '<li>' . $moduleLang['twmenu_help_3'] . '</li>';
    echo '</ul></td></tr>';
    showtablefooter();
    ...
    showformheader('plugins&operation=config&do=' . $pluginid . '&identifier=tom_weixin&pmod=module&act=admin&moduleid=twmenu');
    showtableheader();
    ...
    showtablefooter();
    if(empty($search_cmd)){
        $multi = multi($count, $pagesize, $page, ADMINSCRIPT."?action=plugins&operation=config&do=".$pluginid."&identifier=tom_weixin&pmod=module&act=admin&moduleid=twmenu");	
