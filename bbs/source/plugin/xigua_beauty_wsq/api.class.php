...
HTML;
    ...
    public function get_template()
    {
        ...
        switch($this->template)
        {
            case '3':
                $r = <<<HTML
{stylesheet}<div class="topicBox threadList" tid="<%= Variables.forum_threadlist[i].tid %>" page="<%= Variables.page %>" id="thread<%= Variables.forum_threadlist[i].tid %>">
    {background_pic}
		<div class="topicCon">
