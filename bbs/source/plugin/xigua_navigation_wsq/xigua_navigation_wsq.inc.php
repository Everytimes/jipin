...
if($_GET['xt'] == 'f'){
    ...
    if($vars['forumlistlink']){
        $variable .= '<a style="width:auto;color:#769cdc" class="blockSec db" href="'.$vars['forumlistlink'].'"><i class="incoSec"></i>'.$forum.'</a>';
    }else{
    ...
    if($vars['postthreadlink1']){
        $variable .= '<a style="width:auto;color:#769cdc" class="blockSec db" href="'.$vars['postthreadlink1'].'"><i class="iconPost f18 mr5 commF"></i>'.$postthreadfont.'</a>';
    }else{
