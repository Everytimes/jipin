...
<table cellspacing='1' cellpadding='3' id='listTable'>
  <tr>
    <th align="left"><input type="checkbox" onclick="listTable.selectAll(this, 'areas')" /><?php echo $this->_var['lang']['record_id']; ?></th>
    <th align="left">归属于</th>
    <th align="left"><?php echo $this->_var['lang']['shipping_area_name']; ?></th>
    <th align="left"><?php echo $this->_var['lang']['shipping_area_regions']; ?></th>
    <th align="left"><?php echo $this->_var['lang']['handler']; ?></th>
  </tr>
...
?>
  <tr>
    ...
    <td>
      <?php if ($this->_var['area']['supp_id']): ?>商家<?php else: ?>平台自营<?php endif; ?>
    </td>
    <td class="first-cell">
      <span onclick="listTable.edit(this, 'edit_area', '<?php echo $this->_var['area']['shipping_area_id']; ?>'); return false;"><?php echo htmlspecialchars($this->_var['area']['shipping_area_name']); ?></span>
    </td>
