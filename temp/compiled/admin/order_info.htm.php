...
<table width="100%" cellpadding="3" cellspacing="1">
 ...
 <tr>
  ...
  <tr>
    ...
    <td><?php echo $this->_var['point_info']['region']; ?> <?php echo $this->_var['point_info']['address']; ?> <?php echo $this->_var['point_info']['shop_name']; ?><?php echo $this->_var['point_info']['tel']; ?>   <?php echo $this->_var['order']['best_time']; ?></td>
  ...
  <tr>
    ...
    <td colspan="5"><?php if ($this->_var['operable_list']['confirm']): ?>
      <input name="confirm" type="submit" value="<?php echo $this->_var['lang']['op_confirm']; ?>" class="button" />
        ...
        退支付金额<input type="text" name="refund_money" value="" size="6">（留空全退）
        退优惠券<input type="checkbox" name="refund_bonus" value="1" checked>
        退余额支付<input type="checkbox" name="refund_surplus" value="1" checked>
        <?php endif; ?>
