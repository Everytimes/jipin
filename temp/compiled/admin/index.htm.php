    ...
    <tr>
        <td colspan="2" height="67" valign="top">
                <div class="headermenu" id="topmenu">
                    ...
                    <div></div>
                    <div class="uinfo">
                    <!-- <a href="javascript:;create_index_html();">更新首页静态</a> -->
...
?>,'<?php echo $this->_var['k']; ?>'<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>);
	...
	{
		Ajax.call('../operation_page_index.php','', create_index_htmlResponse, 'GET', 'JSON');
		
		
	}
	function create_index_htmlResponse(result)
	{
		alert('生成完成');
	}
</script>
