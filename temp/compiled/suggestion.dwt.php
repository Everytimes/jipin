    ...
    <div class="suggestion-wrap">
        ...
        <div class="suggestion-body">
            <div class="suggestion-list">
                <?php $_from = $this->_var['suggestion']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'suggestion_0_67592800_1460960184');if (count($_from)):
    foreach ($_from AS $this->_var['suggestion_0_67592800_1460960184']):
?>
                <div class="suggestion-one">
                    <a href="faq.php?id=<?php echo $this->_var['suggestion_0_67592800_1460960184']['article_id']; ?>">
                    <div class="suggestion-title"><?php echo $this->_var['suggestion_0_67592800_1460960184']['title']; ?></div>
                    <div class="suggestion-arrow">
                        <img src="themes/haohaios/images/home_arrow.png">
                    </div>
                    </a>
                </div>
