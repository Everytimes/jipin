...
<?php echo $this->smarty_insert_scripts(array('files'=>'jquery.js,haohaios.js,index.js')); ?>
</head>
<body>
    <div class="help">
    ...
    <div style="display: block;" id="common_rule" class="rule">
        ...
        <p class="rule_row"><span class="rule_num">(6)</span>拼团，是基于好友的组团购买，获取团购优惠，为了保证广大消费者的权益，<?php echo $this->_var['shop_name']; ?>有权将判定为黄牛倒货的团解散并取消订单。</p>
    </div>
</body>
</html>
