...
<body onload="pageheight()">
    ...
    <div class="main" id="main">
		...
		<div class="maincon">
				...
				<div class="contitlelist"><span>添加自提点</span><div class="titleright"><a href="?act=point_list">返回列表</a></div></div>
                <?php else: ?>
                <div class="contitlelist"><span>编辑自提点</span><div class="titleright"><a href="?act=point_list">返回列表</a></div></div>
                <?php endif; ?>
		<div class="conbox">
            
          
          <form enctype="multipart/form-data" action="suppliers.php" method="post" name="theForm" onsubmit="return validate()">
...
<!--           <tr>
          ...
          <tr>
           ...
           <tr>
            ...
            <td><input type="text" name="tel"  class="input" value="<?php echo $this->_var['point']['tel']; ?>" size="30" />&nbsp;
...
?>
                  <li><?php echo $this->_var['item']['uname']; ?> <span class="drop"><a href="?act=drop_point_user&id=<?php echo $this->_var['item']['id']; ?>&point_id=<?php echo $this->_var['point']['id']; ?>&shipping=<?php echo $this->_var['shipping']; ?>">删除</a></span></li>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                </ul>
              </div>
              </td>
...
function delbind(id){
  if(confirm('确定要此操作吗')){
    Ajax.call('suppliers.php?act=delete_join&id='+id,null, delbindResponse, 'GET', 'JSON');
  }
}
...
function validate()
{
    ...
    <span>自提列表</span>
      <div class="titleright"><a href="?act=add_point">新建自提点</a></div>
    </div>
    <div class="conbox">
...
?>
  <tr>
    ...
    <td align="center" nowrap="true">
      <a href="suppliers.php?act=edit_point&id=<?php echo $this->_var['item']['id']; ?>&shipping=<?php echo $this->_var['shipping']; ?>" title="编辑">编辑</a>
     
      <a href="suppliers.php?act=delete_point&id=<?php echo $this->_var['item']['id']; ?>&shipping=<?php echo $this->_var['shipping']; ?>" onclick="return confirm('确定要删除吗');" title="删除">删除</a>
...
?>
    ...
    <td align="center"> 
  	  <a href="suppliers.php?act=shipping_area_list&shipping=<?php echo $this->_var['module']['id']; ?>">设置区域</a>
         <?php if ($this->_var['module']['shipping_code'] == 'cac'): ?>
      	<a href="suppliers.php?act=point_list&shipping=<?php echo $this->_var['module']['id']; ?>">设置取货点</a>
      <?php endif; ?>
...
<?php if ($this->_var['action'] == 'shipping_area_list'): ?>
    ...
    <div class="titleright"><a href="suppliers.php?act=shipping_area_add&id=<?php echo $this->_var['shipping_id']; ?>">新建配送区域</a></div>
    </div>
    <div class="conbox">
  <form method="post" action="suppliers.php" name="listForm" onsubmit="return confirm('您确定要删除选定的配送区域吗？')">
...
?>
    ...
    <a href="suppliers.php?act=shipping_area_edit&id=<?php echo $this->_var['area']['shipping_area_id']; ?>&shipping_id=<?php echo $this->_var['shipping_id']; ?>">编辑</a> | 
    <a onclick="return confirm('您确定要删除选定的配送区域吗？');" href="suppliers.php?act=shipping_area_remove&id=<?php echo $this->_var['area']['shipping_area_id']; ?>&shipping_id=<?php echo $this->_var['shipping_id']; ?>">移除</a>
    </td> 
	</tr>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
<form method="post" action="suppliers.php" name="theForm" onsubmit="return validate()" style="background:#FFF">
...
<?php if ($this->_var['action'] == 'edit_print_template'): ?>
  ...
  <form method="post" name="theForm" action="suppliers.php?act=do_edit_print_template&shipping=<?php echo $this->_var['shipping']['shipping_id']; ?>">
