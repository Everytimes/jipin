...
?>
 ...
 <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      ...
      <div class="titleright"> <a href="javascript:void(0);" id="delivery_download">导出</a> </div>
      <script >
...
document.getElementById('account_print').href="suppliers.php?act=account_print&"+str;
 ...
 -->
          ...
          <th align="center" bgcolor="#FFFFFF">结算佣金</th>
...
<form id="form_data" action="suppliers.php" method="post" name="myform">
    <div class="bnts">
     ...
     <input type="button" onclick="order_i();" value="批量修改订单" name="order_import">
...
function order_i(){
    window.location="suppliers.php?act=import";
}
</script>
				<table cellspacing="0" cellpadding="0" class="listtable">
...
?>
					...
					<tr>
                      ...
                      <td align="center"><?php echo $this->_var['order_list']['consignee']; ?><?php if ($this->_var['order_list']['point_id'] == 0): ?>[TEL:<?php if ($this->_var['order_list']['mobile']): ?><?php echo $this->_var['order_list']['mobile']; ?><?php else: ?><?php echo $this->_var['order_list']['tel']; ?><?php endif; ?>]<br />[<?php echo $this->_var['order_list']['region']; ?>]<?php echo $this->_var['order_list']['address']; ?><?php endif; ?></td>
...
<div>
  ...
  <?php $_from = $this->_var['opt_action_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'action_0_83410500_1464830749');if (count($_from)):
    foreach ($_from AS $this->_var['action_0_83410500_1464830749']):
?>
  <tr>
    <td><div align="center"><?php echo $this->_var['action_0_83410500_1464830749']['action_user']; ?></div></td>
    <td><div align="center"><?php echo $this->_var['action_0_83410500_1464830749']['action_time']; ?></div></td>
    <td><div align="center"><?php echo $this->_var['action_0_83410500_1464830749']['order_status']; ?></div></td>
    <td><div align="center"><?php echo $this->_var['action_0_83410500_1464830749']['pay_status']; ?></div></td>
    <td><div align="center"><?php echo $this->_var['action_0_83410500_1464830749']['shipping_status']; ?></div></td>
    <td><?php echo nl2br($this->_var['action_0_83410500_1464830749']['action_note']); ?></td>
  </tr>
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
</table>
</div>
...
//			}
 	...
 	<div class="main" id="main">
		...
		<div class="maincon" style="color:#000;">
          ...
          <tr>
            ...
            <td><textarea name="goods_brief" id="goods_brief" cols="35" rows="2"><?php echo $this->_var['goods']['goods_brief']; ?></textarea></td>
                     ...
                     <tr>
			<td class="right" width="100">产品标签：</td>
            <td>
        ...
        <input type="text" name="lab_hwzy" id="lab_hwzy" value="<?php echo $this->_var['goods']['lab_hwzy']; ?>" />
          ...
          <tr>
            <td class="right" width="100">产品特色：</td>
            <td>
...
?>
          ...
          <tr>
            <td class="right">是否显示附近的团：</td>
            <td>
              <input type="radio" name="is_nearby" value="1" <?php if ($this->_var['goods']['is_nearby'] == 0): ?>checked="checked"<?php endif; ?>>是
              <input type="radio" name="is_nearby" value="0" <?php if ($this->_var['goods']['is_nearby'] == 1): ?>checked="checked"<?php endif; ?>>否
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
                ...
                <label><input type="radio" id="un_luck" name="is_luck" onchange="set_luck(0);" value="0"<?php if ($this->_var['goods']['is_luck'] == 0): ?>checked='checked'<?php endif; ?>>否</label>  <font color="red">和秒杀产品只能二选一</font> <font color="blue">抽奖产品团购价格必须大于￥1 </font>
            </td>
          </tr>
          <tr>
            <td class="right">抽奖期数：</td>
            <td>
                <input type="text" name="luck_times" value="<?php echo $this->_var['goods']['luck_times']; ?>"> <font color="red">期数不得有重复，每期完成之后请重新设置</font>
            </td>
          </tr> 
          <tr>
            <td class="right">抽奖中奖人数：</td>
            <td>
                <input type="text" name="luck_num" value="<?php echo $this->_var['goods']['luck_num']; ?>"> 中奖人数，最少为1，<font color="red">请设置参团人数和库存数量一致</font>
            </td>
          </tr>    
          <tr id="promote_4">
            <td class="right" id="promote_5">抽奖/秒杀时间</td>
            <td id="promote_6">
              ...
              <?php else: ?>
                <img src="templates/images/no.gif" />
              <?php endif; ?> &nbsp;&nbsp;大小建议120像素*120像素  <font style="color:#F00">*</font> 
                </td>
              </tr>
...
?>
        ...
        <tr>
          ...
          <td width="30%" align="right">客服QQ：</td>

          <td>

          <input name="qq" type="text" size="40" id="qq" class="input"  value="<?php echo $this->_var['supp_list']['qq']; ?>" />
