...
<div>
  ...
  <?php $_from = $this->_var['opt_action_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'action_0_42685400_1459473528');if (count($_from)):
    foreach ($_from AS $this->_var['action_0_42685400_1459473528']):
?>
  <tr>
    <td><div align="center"><?php echo $this->_var['action_0_42685400_1459473528']['action_user']; ?></div></td>
    <td><div align="center"><?php echo $this->_var['action_0_42685400_1459473528']['action_time']; ?></div></td>
    <td><div align="center"><?php echo $this->_var['action_0_42685400_1459473528']['order_status']; ?></div></td>
    <td><div align="center"><?php echo $this->_var['action_0_42685400_1459473528']['pay_status']; ?></div></td>
    <td><div align="center"><?php echo $this->_var['action_0_42685400_1459473528']['shipping_status']; ?></div></td>
    <td><?php echo nl2br($this->_var['action_0_42685400_1459473528']['action_note']); ?></td>
  </tr>
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
</table>
</div>
