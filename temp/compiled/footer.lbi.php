<div class="footer">
    <ul>
        <li><a href="index.php" class="nav-index"><i class="icon-index"></i>首页</a></li>
		<li><a href="catalog.php" class="nav-catalog"><i class="icon-catalog"></i>分类</a></li>
		<li><a href="http://www.1jipin.com/bbs" class="nav-square"><i class="icon-square"></i>团员之家</a></li>
        <li><a href="rank.php?act=hot" class="nav-rank"><i class="icon-rank"></i>热榜</a></li>
