                             ...
                             function changenum(rec_id){
								...
								{    
									if (result.error == 0)
									{
										...
										{//更新购物车数量
										   document.getElementById('HHS_CARTINFO').innerHTML = result.cart_info;
										}
									}
...
?>
    ...
    <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="" id="paymentTable">
             ...
             <tr>
              <td style="padding-left:10px;" bgcolor=""><strong><?php echo $this->_var['lang']['use_integral']; ?></strong></td>
              <td ><input name="integral" type="text" class="input" id="HHS_INTEGRAL" onblur="changeIntegral(this.value)" value="<?php echo empty($this->_var['order']['integral']) ? '0' : $this->_var['order']['integral']; ?>" size="10" />
              <?php echo $this->_var['lang']['can_use_integral']; ?>:<?php echo empty($this->_var['your_integral']) ? '0' : $this->_var['your_integral']; ?> <?php echo $this->_var['points_name']; ?>，<?php echo $this->_var['lang']['noworder_can_integral']; ?><?php echo $this->_var['order_max_integral']; ?>  <?php echo $this->_var['points_name']; ?>. <span id="HHS_INTEGRAL_NOTICE" class="notice"></span></td>
            </tr>
            <?php endif; ?>
            <?php if ($this->_var['allow_use_bonus']): ?>
              <tr>
                <td style="padding-left:10px;" bgcolor=""><strong><?php echo $this->_var['lang']['use_bonus']; ?></strong></td>
                <td>
                  <?php echo $this->_var['lang']['select_bonus']; ?>
                  <select name="bonus" onchange="changeBonus(this.value)" id="HHS_BONUS" style="border:1px solid #ccc;">
...
?>
              ...
              <tr>
                <td style="padding-left:10px;" bgcolor=""><strong><?php echo $this->_var['lang']['input_bonus_no']; ?></strong></td>
                <td>

                               <input name="bonus_sn" type="text" class="inputBg" size="10" value="<?php echo $this->_var['order']['bonus_sn']; ?>" />
