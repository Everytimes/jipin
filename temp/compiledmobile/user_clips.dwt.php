...
<div class="login">
		...
		<dl class="mb-user"> 
			<dt>
                <?php if ($this->_var['wx_user']['headimgurl']): ?><img id="J_myLogo" src="<?php echo $this->_var['wx_user']['headimgurl']; ?>"><?php else: ?><img id="J_myLogo" src="themes/default/images/get_avatar.jpg"><?php endif; ?>
		...
		<div class="mb-os"> 
			<ul>
				<li id="J_toPay"> 
				<a class="fragment" ><strong>30天订单 <?php echo $this->_var['info']['order_count']; ?></strong></a>
				</li> 
				<li id="J_hasPaid"> 
				<a class="fragment"  ><strong><?php echo $this->_var['info']['integral']; ?></strong>
                </a>
				</li> 
				<li id="J_toConfirm"> 
				<a class="fragment" href="user.php?act=account_log"  ><strong>余额:<?php echo $this->_var['info']['surplus']; ?></strong></a>
				</li> 
				<li id="J_toComment"> 
				<a class="fragment" href="user.php?act=bonus"  ><strong><?php echo $this->_var['info']['bonus']; ?></strong></a>
				</li> 
			</ul> 
		</div>
		...
		<a href="user.php?act=affiliate&u=<?php echo $this->_var['user_id']; ?>" class="mb-icon8 fragment"><?php echo $this->_var['lang']['label_affiliate']; ?></a>
...
//-->
         ...
         <div class="blank"></div>
         <h5><span>分享到朋友圈或扫描二维码关注</span></h5>
         <div class="blank"></div>
         <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
             <tr align="center" bgcolor="#ffffff">
                 <?php if ($this->_var['qr_img']): ?><img src="<?php echo $this->_var['qr_img']; ?>" width="320"  /><?php else: ?>微信二维码获取失败<br><a href="<?php echo $this->_var['shopurl']; ?>user.php?act=affiliate&u=<?php echo $this->_var['userid']; ?>" style="font-size: 14px;">点击重新获取</a><?php endif; ?>
             </tr>
         </table>
        <?php else: ?>
...
?>
    <tr align="center">
      <td bgcolor="#ffffff" class="types"><script src="<?php echo $this->_var['shopurl']; ?>affiliate.php?charset=<?php echo $this->_var['hhs_charset']; ?>&gid=<?php echo $this->_var['goodsid']; ?>&u=<?php echo $this->_var['userid']; ?>&type=<?php echo $this->_var['val']; ?>"></script></td>
      <td bgcolor="#ffffff">javascript <?php echo $this->_var['lang']['affiliate_codetype']; ?><br>
        <textarea cols=30 rows=2 id="txt<?php echo $this->_foreach['types']['iteration']; ?>" style="border:1px solid #ccc;"><script src="<?php echo $this->_var['shopurl']; ?>affiliate.php?charset=<?php echo $this->_var['hhs_charset']; ?>&gid=<?php echo $this->_var['goodsid']; ?>&u=<?php echo $this->_var['userid']; ?>&type=<?php echo $this->_var['val']; ?>"></script></textarea>[<a href="#" title="Copy To Clipboard" onClick="Javascript:copyToClipboard(document.getElementById('txt<?php echo $this->_foreach['types']['iteration']; ?>').value);alert('<?php echo $this->_var['lang']['copy_to_clipboard']; ?>');"  class="f6"><?php echo $this->_var['lang']['code_copy']; ?></a>]
<br>iframe <?php echo $this->_var['lang']['affiliate_codetype']; ?><br><textarea cols=30 rows=2 id="txt<?php echo $this->_foreach['types']['iteration']; ?>_iframe"  style="border:1px solid #ccc;"><iframe width="250" height="270" src="<?php echo $this->_var['shopurl']; ?>affiliate.php?charset=<?php echo $this->_var['hhs_charset']; ?>&gid=<?php echo $this->_var['goodsid']; ?>&u=<?php echo $this->_var['userid']; ?>&type=<?php echo $this->_var['val']; ?>&display_mode=iframe" frameborder="0" scrolling="no"></iframe></textarea>[<a href="#" title="Copy To Clipboard" onClick="Javascript:copyToClipboard(document.getElementById('txt<?php echo $this->_foreach['types']['iteration']; ?>_iframe').value);alert('<?php echo $this->_var['lang']['copy_to_clipboard']; ?>');" class="f6"><?php echo $this->_var['lang']['code_copy']; ?></a>]
