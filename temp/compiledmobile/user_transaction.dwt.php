...
?>
          ...
          <td><span id="HHS_RESULT">0</span></td>
          </tr>
          <tr>
...
?>
            ...
            function calPoints()
            {
              ...
              {
                document.getElementById('HHS_RESULT').innerHTML = invalid_input;
                rerutn;
              }
              var arr = rate.split(':');
              ...
              document.getElementById('HHS_RESULT').innerHTML = parseInt(num * to / from);
            }

            function changeRule()
            {
              document.forms['theForm'].elements['num'].value = 0;
              document.getElementById('HHS_RESULT').innerHTML = 0;
            }
          //]]>
       </script>
       <?php endif; ?>
